...
import { idlFactory } from './fileupload_assets.did.js';
export { idlFactory } from './fileupload_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FILEUPLOAD_ASSETS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./fileupload_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the fileupload_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./fileupload_assets.did.js")._SERVICE>}
 */
export const fileupload_assets = createActor(canisterId);
