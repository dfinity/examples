...
This demo goes in hand with the [developer documentation on HTTPS outcalls](https://docs.internetcomputer.org/building-apps/network-features/using-http/https-outcalls/get).
