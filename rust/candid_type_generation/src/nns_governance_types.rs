...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct AccountIdentifier { hash: Vec<u8> }

#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct Account { owner: Option<candid::Principal>, subaccount: Option<Vec<u8>> }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct RemoveHotKey { hot_key_to_remove: Option<candid::Principal> }

#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct AddHotKey { new_hot_key: Option<candid::Principal> }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct SetVisibility { visibility: Option<i32> }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct SetFollowing { topic_following: Option<Vec<FolloweesForTopic>> }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub enum NeuronIdOrSubaccount { Subaccount(Vec<u8>), NeuronId(NeuronId) }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct Controllers { controllers: Vec<candid::Principal> }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct Canister { id: Option<candid::Principal> }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct ExecuteNnsFunction { nns_function: i32, payload: Vec<u8> }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct TimeWindow { start_timestamp_seconds: u64, end_timestamp_seconds: u64 }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct Decimal { human_readable: Option<String> }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct Principals { principals: Vec<candid::Principal> }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct BallotInfo { vote: i32, proposal_id: Option<ProposalId> }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub enum Result { Ok, Err(GovernanceError) }

#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub enum Result_1 { Error(GovernanceError), NeuronId(NeuronId) }

#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct ClaimOrRefreshNeuronFromAccountResponse { result: Option<Result_1> }

#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub enum Result_2 { Ok(Neuron), Err(GovernanceError) }

#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub enum Result_3 { Ok(GovernanceCachedMetrics), Err(GovernanceError) }

#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub enum Result_4 { Ok(MonthlyNodeProviderRewards), Err(GovernanceError) }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub enum Result_5 { Ok(NeuronInfo), Err(GovernanceError) }

#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct GetNeuronsFundAuditInfoRequest { nns_proposal_id: Option<ProposalId> }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct Ok { neurons_fund_audit_info: Option<NeuronsFundAuditInfo> }

#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub enum Result_6 { Ok(Ok), Err(GovernanceError) }

#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct GetNeuronsFundAuditInfoResponse { result: Option<Result_6> }

#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub enum Result_7 { Ok(NodeProvider), Err(GovernanceError) }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct NeuronSubaccount { subaccount: Vec<u8> }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct ListNodeProviderRewardsRequest { date_filter: Option<DateRangeFilter> }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct DisburseMaturityResponse { amount_disbursed_e8s: Option<u64> }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub enum Result_8 { Committed(Committed), Aborted{} }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub enum Result_9 { Committed(Committed_1), Aborted{} }
...
#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct Ok_1 { neurons_fund_neuron_portions: Vec<NeuronsFundNeuron> }

#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub enum Result_10 { Ok(Ok_1), Err(GovernanceError) }

#[derive(CandidType, Deserialize, Debug, Clone, serde::Serialize)]
pub struct SettleNeuronsFundParticipationResponse { result: Option<Result_10> }
