...
[Read more about how to use the ICP ledger locally](https://internetcomputer.org/docs/defi/token-ledgers/usage/icp_ledger_usage).

## Deploying from ICP Ninja

[![](https://icp.ninja/assets/open.svg)](https://icp.ninja/editor?g=https://github.com/dfinity/examples/tree/master/motoko/icp_transfer)
