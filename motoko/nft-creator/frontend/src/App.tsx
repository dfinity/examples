      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        {identity ? (
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="bg-gray-800 rounded-lg p-4 sm:p-6 border border-gray-700">
              <h2 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-purple-300">Collection Management</h2>
              <CollectionClaim />
            </div>

            {/* Minting Section */}
            <div className="bg-gray-800 rounded-lg p-4 sm:p-6 border border-gray-700">
              <h2 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-purple-300">Mint NFT</h2>
              <MintNFT />
            </div>

            {/* Owned NFTs */}
            <div className="bg-gray-800 rounded-lg p-4 sm:p-6 border border-gray-700">
              <h2 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-purple-300">Your NFTs</h2>
              <OwnedNFTs />
            </div>
          </div>
        ) : (
          <div className="text-center py-8 sm:py-16">
            <div className="bg-gray-800 rounded-lg p-6 sm:p-8 max-w-sm sm:max-w-md mx-auto border border-gray-700">
              <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">Welcome to NFT Collection Manager</h2>
        ...
        <footer className="mt-12 sm:mt-16 text-center text-gray-500 text-xs sm:text-sm px-4">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-1">
            <span>© 2025. Built with <Heart className="inline w-4 h-4 text-red-500" /> using</span>
            <a 
