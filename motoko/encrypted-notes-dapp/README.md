...
2. Click the "Login" button. You will be redirected to the _Internet Identity_ canister (see Pic. (b)).
   ...
   - If you already have an `anchor`, you may continue with it. Click "Authenticate", then verify your identity and finally click "Proceed", see Pic. (c).
   - If you do not have an anchor yet, you should [create one](https://smartcontracts.org/docs/ic-identity-guide/auth-how-to.html). Once an `anchor` is created, please follow 2.1.
