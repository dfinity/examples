    ...
    */
    to_aes_256_gcm_key() {
        try {
            ...
            wasm.decryptedkey_to_aes_256_gcm_key(retptr, this.__wbg_ptr);
...
export class EncryptedKey {
    ...
    */
    decrypt_and_verify(tsk, derived_public_key_bytes, derivation_id) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(tsk, TransportSecretKey);
            ...
            wasm.encryptedkey_decrypt_and_verify(retptr, this.__wbg_ptr, tsk.__wbg_ptr, ptr0, len0, ptr1, len1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    constructor(bytes) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.encryptedkey_from_bytes_vec(retptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
export class TransportPublicKey {
    ...
    */
    to_bytes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.transportpublickey_to_bytes(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var v1 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 1);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('ic_vetkd_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
