...
# Cleanup any leftover state from a previous run so tests are idempotent.
icp canister call backend deleteFile '("test.txt")' >/dev/null 2>&1 || true
