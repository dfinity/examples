...
1. For this example we are generating the keypair in the dapp, in your production application make sure this is generated by your native app, this will ensure that your dapp is resistant to XSS vulnerabilities.
