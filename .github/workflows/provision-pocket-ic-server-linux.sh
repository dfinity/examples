...
POCKET_IC_SERVER_VERSION=${POCKET_IC_SERVER_VERSION:=3.0.1}
...
curl -sSL "https://github.com/dfinity/pocketic/releases/download/${POCKET_IC_SERVER_VERSION}/pocket-ic-x86_64-linux.gz" -o ${POCKET_IC_SERVER_PATH}.gz
